...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get popular cities' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return popular cities' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)(':slug'),
    (0, swagger_1.ApiOperation)({ summary: 'Get city by slug' }),
    ...
    __metadata("design:returntype", void 0)
], CitiesController.prototype, "findBySlug", null);
