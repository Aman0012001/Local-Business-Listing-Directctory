...
], CreateLeadDto.prototype, "businessId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: lead_entity_1.LeadType, example: lead_entity_1.LeadType.CHAT }),
    (0, class_validator_1.IsEnum)(lead_entity_1.LeadType),
    __metadata("design:type", String)
], CreateLeadDto.prototype, "type", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'I am interested in your services' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'web-listing' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
