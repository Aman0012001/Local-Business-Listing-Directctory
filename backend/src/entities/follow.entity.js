...
var Follow = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('follows')];
    ...
    var Follow = _classThis = /** @class */ (function () {
        function Follow_1() {
    ...
    (function () {
        ...
        _user_decorators = [(0, class_transformer_1.Exclude)(), (0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.follows; }), (0, typeorm_1.JoinColumn)({ name: 'user_id' })];
        _business_decorators = [(0, class_transformer_1.Exclude)(), (0, typeorm_1.ManyToOne)(function () { return business_entity_1.Listing; }, function (listing) { return listing.follows; }), (0, typeorm_1.JoinColumn)({ name: 'business_id' })];
