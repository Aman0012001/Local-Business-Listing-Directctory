...
export default function GenericDashboard() {
    ...
    const vendorStats = [
        ...
        },
        {
            ...
            onClick: () => router.push('/pending-listings'),
            show: hasFeature('showListings')
        },
        {
            label: 'Total Views',
            ...
            >
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    ...
                    {((isVendor || isAdmin) ? hasFeature('canAddListing') : false) && (
                        <Link href="/add-listing" className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-[16px] font-black  shadow-slate-200 hover:scale-105 active:scale-95 transition-all w-fit">
                ...
                <div className="lg:col-span-8 space-y-10">
                    ...
                    {((isVendor || isAdmin) ? hasFeature('showSaved') : true) && (
                        ...
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <Link href="/saved" className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-blue-600 transition-all group/link">
                    ...
                    {((isVendor || isAdmin) ? hasFeature('showFollowing') : true) && (
                        ...
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <Link href="/following" className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-blue-600 transition-all group/link">
                    ...
                    {((isVendor || isAdmin) && hasFeature('showChat')) && (
                        <section className="bg-white rounded-[16px] p-8 border border-black shadow-slate-200/20">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <Link href="/chat" className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-blue-600 transition-all flex items-center gap-1">
                    ...
                    {isVendor && hasFeature('showQueries') && (
                        <section className="bg-white rounded-[16px] p-8 border border-black  shadow-slate-200/20 opacity-60 grayscale-[0.5] scale-95 origin-top">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <Link href="/messages" className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-slate-600">
                                    Full Leads Inbox →
                                </Link>
                            </div>
                        ...
                        <section className="bg-slate-900 rounded-[16px] p-8 border border-slate-800 shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <Link href="/affiliate" className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-white transition-all flex items-center gap-1">
