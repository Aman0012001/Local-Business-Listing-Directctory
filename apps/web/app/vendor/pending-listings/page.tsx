    ...
    if (isVendor && activeSub && features.showListings === false) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 bg-white rounded-3xl border-2 border-dashed border-slate-100 mt-20">
                ...
                <h2 className="text-3xl font-black text-slate-900 mb-3">Pending Listings</h2>
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <Link href="/vendor/listings" className="text-sm font-black text-blue-600 hover:text-blue-700 bg-blue-50 px-6 py-3 rounded-2xl transition-all">
                    View All Listings
                </Link>
            </div>
