                    ...
                    <div className="bg-white rounded-[32px] border border-slate-100 p-8 md:p-10 shadow-2xl shadow-blue-500/5">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <button
                                disabled={loading}
                                type="submit"
                                className="w-full py-5 bg-[#112D4E] hover:bg-black text-white rounded-2xl font-black text-sm flex items-center justify-center gap-3 transition-all shadow-xl shadow-slate-900/10 active:scale-95 disabled:opacity-50"
                            >
